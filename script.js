...
function validateLanguage() {
    ...
    if(document.getElementById('Tamil').checked) {
         ...
         formData["language"].push(document.getElementById('English').value);
                return true;
     }else if (document.getElementById('Hindhi').checked) {
         formData["language"].push(document.getElementById('Hindhi').value);
         return true;
     } else {
...
function resetForm(){
    ...
    if(document. getElementById('male'). checked) {
     ...
     if (document. getElementById("Hindhi"). checked) {
        document.getElementById("Hindhi").checked = false;
     }
